        ...
        <Link href={`/calendar/${eventId}/attendance`} className="block">
          <Card className="h-full cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-800">
            <CardContent className="flex flex-col items-center gap-2 py-5">
              ...
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">出欠回答</span>
            </CardContent>
          </Card>
        </Link>
        <Link href={`/calendar/${eventId}/members`} className="block">
          <Card className="h-full cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-800">
            <CardContent className="flex flex-col items-center gap-2 py-5">
              ...
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">参加者リスト</span>
            </CardContent>
          </Card>
        </Link>
      </div>
