...
DROP POLICY IF EXISTS "players_select_team_member" ON players;
...
DROP POLICY IF EXISTS "user_children_select_team_member" ON user_children;
...
DROP POLICY IF EXISTS "events_select_team_member" ON events;
...
DROP POLICY IF EXISTS "event_attendances_select_team" ON event_attendances;
...
DROP POLICY IF EXISTS "posts_select_team_member" ON posts;
...
DROP POLICY IF EXISTS "post_reactions_select_team" ON post_reactions;
...
DROP POLICY IF EXISTS "post_comments_select_team" ON post_comments;
...
DROP POLICY IF EXISTS "game_scorebook_images_select_team" ON game_scorebook_images;
...
DROP POLICY IF EXISTS "game_lineups_select_team" ON game_lineups;
...
DROP POLICY IF EXISTS "player_game_stats_select_team" ON player_game_stats;
...
DROP POLICY IF EXISTS "player_measurements_select_parent" ON player_measurements;
...
DROP POLICY IF EXISTS "player_fitness_records_select_team" ON player_fitness_records;
...
DROP POLICY IF EXISTS "player_badges_select_team" ON player_badges;
...
DROP POLICY IF EXISTS "player_milestones_select_team" ON player_milestones;
...
DROP POLICY IF EXISTS "milestone_comments_select_team" ON milestone_comments;
...
DROP POLICY IF EXISTS "weekly_awards_select_team" ON weekly_awards;
...
DROP POLICY IF EXISTS "player_goals_select_team" ON player_goals;
...
DROP POLICY IF EXISTS "goal_comments_select_team" ON goal_comments;
...
DROP POLICY IF EXISTS "team_challenges_select_team" ON team_challenges;
...
DROP POLICY IF EXISTS "best_plays_select_team" ON best_plays;
...
DROP POLICY IF EXISTS "monthly_reviews_select_team" ON monthly_reviews;
...
DROP POLICY IF EXISTS "photo_likes_select_team" ON photo_likes;
...
DROP POLICY IF EXISTS "team_profiles_select_public" ON team_profiles;
CREATE POLICY "team_profiles_select_public" ON team_profiles FOR SELECT USING (is_public = true AND auth.uid() IS NOT NULL);
DROP POLICY IF EXISTS "team_profiles_select_own_team" ON team_profiles;
...
DROP POLICY IF EXISTS "head_to_head_records_select_team" ON head_to_head_records;
